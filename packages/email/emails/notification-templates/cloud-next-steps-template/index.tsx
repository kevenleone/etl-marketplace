...
export default function CloudNextStepsTemplate() {
    return (
        <TrialLayout preview="Next Steps">
             ...
             <Heading as="h2" className="text-[30px] font-bold m-0 mb-4 mt-[2.5rem] text-black">Next Steps</Heading>
             ...
             <Section className="text-center mx-[11rem] mb-[2.5rem]"> 
                 ...
                 */}
                 <Text className="text-text text-center m-0 mb-4">
                    Congratulations on the purchase of <b>[%GETAPPINFORMATION_PRODUCTNAME%]</b>. You
                    will need to deploy the app to your project in
                    the Cloud Console. To access the Cloud Console,
                    click the button below and provide your Order ID
                    when prompted.
                 </Text>
             ...
             <Section className="text-center mb-[2.5rem]">
                <Link href="[%GETAPPINFORMATION_DASHBOARDLINK%]" className="bg-primary text-white font-bold py-2 px-6 rounded-lg text-base no-underline inline-block w-[10rem]">
                    Go to Dashboard
                </Link>
             </Section>
        </TrialLayout>

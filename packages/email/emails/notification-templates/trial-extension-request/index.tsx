...
export default function TrialExtensionRequest() {
    return (
        <TrialLayout preview="Trial Extension Requested" style={{ maxWidth: '640px' }}>
             ...
             <Section>
                ...
                <Text className="text-base text-text mb-4">
                    User <span className="font-bold">[%TRIALEXTENSIONREQUEST_AUTHOR_FIRST_NAME%]</span> has requested a <span className="font-bold">[%TRIALEXTENSIONREQUEST_DURATION%]</span>-day extension for trial environment <span className="font-bold">[%TRIALEXTENSIONREQUEST_PROJECTID%]</span>.
                </Text>

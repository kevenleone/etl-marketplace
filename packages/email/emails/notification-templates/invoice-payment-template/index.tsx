    ...
    return (
        <Layout preview="New Order Placed">
            ...
            <Text className="text-base text-text m-0 mb-6">
                ...
                <span className="font-bold">[%ACCOUNT_NAME%]</span>. Below you
                can find the order and account details for Finance review and
                processing.
            </Text>
            ...
            <Text className="text-sm m-0">
                Order Date: <span className="font-bold">[%ORDER_DATE%]</span>
            </Text>
            <Text className="text-sm m-0">
                Order Payment Method:{' '}
                <span className="font-bold">[%ORDER_PAYMENT_METHOD%]</span>
            </Text>
            <Text className="text-sm m-0 mb-4">
                Order Status:{' '}
                <span className="font-bold">[%ORDER_STATUS%]</span>
            </Text>
            ...
            <Section className="text-[#282934] text-sm mb-4">
                ...
                <Row>
                    ...
                    <Column width="20">
                        <span
                            title="Exchange rate applied on [%ORDER_DATE%]"
            ...
            <Text className="text-sm m-0">
                Account ID: <span className="font-bold">[%ACCOUNT_ID%]</span>
            </Text>
            <Text className="text-sm m-0">
                Tax/VAT ID: <span className="font-bold">[%VAT_NUMBER%]</span>
            </Text>
            <Text className="text-sm m-0 mb-4">
                Payment Terms:{' '}
                <span className="font-bold">[%PAYMENT_TERMS%]</span>
            </Text>
            ...
            <Text className="text-sm m-0">
                Contact Person:{' '}
                <span className="font-bold">[%BILLING_ADDRESS_NAME%]</span>
            </Text>
            <Text className="text-sm m-0">
                E-mail: <span className="font-bold">[%EMAIL_ADDRESS%]</span>
            </Text>
            <Text className="text-sm m-0 mb-4">
                Phone Number:{' '}
                <span className="font-bold">[%BILLING_ADDRESS_PHONE%]</span>
            </Text>
        </Layout>
    );
}

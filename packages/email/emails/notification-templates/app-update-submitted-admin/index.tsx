...
export default function AppUpdateSubmittedAdmin() {
    return (
        <Layout preview="Updated App Submission Pending Your Review">
             <Heading className="text-[32px] font-bold text-heading mb-6 text-center">Updated App Submission Pending Your Review</Heading>
             
             <Section className="mb-6">
                <Text className="text-base text-text m-0 mb-6">
                    A publisher has submitted an update to an existing app on the marketplace.
                    Please review the updated submission in the admin panel.
                </Text>
             </Section>
             ...
             <Section className="mb-6">
                <Text className="text-base text-text m-0 mb-4">
                    Once approved, the updated app will go live, replacing the previous version on the marketplace.
                </Text>
